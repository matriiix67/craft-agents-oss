...
export function AcceptPlanDropdown({
  ...
  const handlePrimaryAccept = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
    handleClose()
    onAccept()
  ...
  return (
    <>
      {/* Split trigger: primary click accepts, chevron opens secondary choices. */}
      <div
        ref={triggerRef}
        className={cn(
          "inline-flex h-[28px] items-center rounded-[6px] bg-success/5 text-success shadow-tinted transition-all",
          "hover:bg-success/10",
          className
        )}
      ...
      >
        <button
          ...
          className={cn(
            "flex h-full items-center gap-1.5 rounded-l-[6px] pl-2.5 pr-1.5 text-xs font-medium transition-colors",
            "focus:outline-none focus-visible:ring-1 focus-visible:ring-success/60"
          )}
        >
        ...
        <button
          ...
          aria-haspopup="menu"
          aria-label={t('plan.acceptAndCompact')}
          title={t('plan.acceptAndCompact')}
          className={cn(
            "flex h-full items-center rounded-r-[6px] border-l border-success/15 pl-1.5 pr-2 transition-colors",
            "hover:bg-success/10 focus:outline-none focus-visible:ring-1 focus-visible:ring-success/60"
          )}
        >
